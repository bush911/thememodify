...
/* == 强制居中修复补丁 (终极版) == */
/* 说明：使用 !important 是为了覆盖 #write p {text-align: left} 这个高优先级的默认规则 */
...
/* 2. 针对 <center> 内部的 p 标签 - 这是最关键的修复 */
/* 无论是否点击编辑，只要在 center 内部，所有的段落强制居中 */
#write center p {
    text-align: center !important;
    margin-left: auto;
    margin-right: auto;
...
/* 3. 针对 Typora 特有的 HTML 预览块 */
/* 确保预览容器本身也响应居中 */
#write .md-rawblock-preview center,
#write .md-rawblock-container center {
    display: block !important;
    text-align: center !important;
}

/* 4. 针对图片本身 */
/* 如果某些情况下图片被渲染为 block，确保它有自动边距 */
#write center img,
#write center .md-image {
    margin: 0 auto !important;
    display: inline-block; /* 确保图片表现为内联块，可以被父级 text-align 控制 */
}

/* 5. 兼容 HTML align 属性 (如 <div align="center"> 或 <p align="center">) */
